...
import { generatePersonUrl, ROUTES } from '@/utils/urlHelpers';
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Kenau Reeves, Leonardo DiCaprio, Brad Pitt..."
                value={searchQuery}
              ...
              {filteredAndSortedFavorites.map((person, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    {/* Ver perfil */}
                    <Link href={generatePersonUrl(person.id, person.name)} className="p-2 bg-green-500/20 text-green-400 rounded-lg hover:bg-green-500/30 transition-colors duration-200">
                      <FiUser className="h-4 w-4" />
                    </Link>
